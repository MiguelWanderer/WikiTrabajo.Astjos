...
export default function ActiveDirectoryAstJos() {
  ...
  const images = [
    { src: '/src/docs_AstJos/img_AstJos/PASO B/Trabajo Inacap.Instantanea1 Paso B.1.png', alt: 'Paso B.1', caption: 'Paso B.1' },
    { src: '/src/docs_AstJos/img_AstJos/PASO B/Trabajo Inacap.Instantanea1 Paso B.1.2.png', alt: 'Paso B.1.2', caption: 'Paso B.1.2' },
    { src: '/src/docs_AstJos/img_AstJos/PASO B/Trabajo Inacap.Instantanea1 Paso B.2.png', alt: 'Paso B.2', caption: 'Paso B.2' },
    { src: '/src/docs_AstJos/img_AstJos/PASO B/Trabajo Inacap.Instantanea1 Paso B.2.1.png', alt: 'Paso B.2.1', caption: 'Paso B.2.1' },
    { src: '/src/docs_AstJos/img_AstJos/PASO B/Trabajo Inacap.Instantanea1 Paso B.2.2.png', alt: 'Paso B.2.2', caption: 'Paso B.2.2' },
  ]
