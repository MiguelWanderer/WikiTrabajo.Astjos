...
export default function GpoAstJos() {
  ...
  const images = [
      { src: 'src/docs_AstJos/img_AstJos/PASO E/Gpo/F_Paso_1.png', alt: 'Paso 1', caption: 'Paso 1' },
      { src: 'src/docs_AstJos/img_AstJos/PASO E/Gpo/F_Paso_2.png', alt: 'Paso 2', caption: 'Paso 2' },
      { src: 'src/docs_AstJos/img_AstJos/PASO E/Gpo/F_Paso_3.png', alt: 'Paso 3', caption: 'Paso 3' },
      { src: 'src/docs_AstJos/img_AstJos/PASO E/Gpo/F_Paso_4.png', alt: 'Paso 4', caption: 'Paso 4' },
