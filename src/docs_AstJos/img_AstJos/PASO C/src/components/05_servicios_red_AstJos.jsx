...
export default function ServiciosRedAstJos() {
  ...
  const images = [
     { src: '/img_AstJos/PASO D/12.1.png', alt: 'Buscamos Agregar roles y características', caption: 'Buscamos Agregar roles y características' },
     { src: '/img_AstJos/PASO D/12.2.png', alt: 'Marcar Servidor DHCP,La instalacion se realiza de forma automatica', caption: 'Marcar Servidor DHCP,La instalacion se realiza de forma automatica' },
     { src: '/img_AstJos/PASO D/12.3.png', alt: 'Al terminar,completar la configuración de DHCP desde la bandera de notificación.', caption: 'Al terminar,completar la configuración de DHCP desde la bandera de notificación.' },
     { src: '/img_AstJos/PASO D/12.4.png', alt: '.', caption: '.' },
     { src: '/img_AstJos/PASO D/12.5.png', alt: '.', caption: '.' },
     { src: '/img_AstJos/PASO D/12.6.png', alt: '.', caption: '.' },
  ]
  const goToPrevious = () => {
