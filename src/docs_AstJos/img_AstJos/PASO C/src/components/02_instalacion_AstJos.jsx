...
export default function InstalacionAstJos() {
  ...
  const images = [
    { src: '/img_AstJos/PASO A/PASO A (1.0).png', alt: 'Paso A (1.0) - Descargar elementos necesarios', caption: 'Paso  - Descargar elementos necesarios' },
    { src: '/img_AstJos/PASO A/PASO A (1.1).png', alt: 'Paso A (1.1) - Verificamos que nuestra ISO de Windows', caption: 'Paso  - Verificamos que Nuestra Iso de Windows,Windows server 2025 esten correctamente descargadas' },
    { src: '/img_AstJos/PASO A/PASO A (2).png', alt: 'Paso A (2) - Configuración (Usuario y contraseña)', caption: 'Paso  - Configurar el sistema operativo.Con un usuario especifico y con una contraseña segura y que repetiremos en el resto del proceso' },
    { src: '/img_AstJos/PASO A/PASO A (4).png', alt: 'Paso A (4) - Configuración (Recursos: 50GB, 4GB RAM, 2 cores)', caption: 'Paso  - Configuración (Recursos: 50GB, 4GB RAM, 2 cores)' },
    { src: '/img_AstJos/PASO A/PASO A (5).png', alt: 'Paso A (5) - Configuración Red REDLAB', caption: 'Paso  - Configuración Red REDLAB' },
    { src: '/img_AstJos/PASO A/PASO A (6).png', alt: 'Paso A (6) - Esperamos que se instale', caption: 'Paso  - Esperamos que se instale' },
    { src: '/img_AstJos/PASO A/PASO A (7).png', alt: 'Paso A (7) - Configurar nombre del servidor (SRV-DC01)', caption: 'Paso  - Configurar nombre del servidor (SRV-DC01)' },
        { src: '/img_AstJos/PASO A/PASO A (6).png', alt: 'Paso A (7) - Reiniciamos', caption: 'Paso  - Reiniciamos' },
    { src: '/img_AstJos/PASO A/PASO A (8).png', alt: 'Paso A (8) - Configurar IP fija (192.168.10.10)', caption: 'Paso  - Configurar IP fija (192.168.10.10)' },
    { src: '/img_AstJos/PASO A/PASO A (9).png', alt: 'Paso A (9) - Verificar Firewall activo', caption: 'Paso  - Verificar Firewall activo' },
  ]
